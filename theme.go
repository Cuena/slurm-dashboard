...
func newTheme(mode ThemeMode, surfaces SurfaceMode, palette Palette) Theme {
	...
	case PaletteClassic:
		return Theme{
			...
			SurfaceAlt:   pickSurface(mode, surfaces, "#FDFEFF", "#161A24"),
			...
			SelectionBg:  pickColor(mode, "#D8E7FF", "#314C73"),
			SelectionFg:  pickColor(mode, "#0B0D19", "#F8FBFF"),
	...
	default: // PaletteDraculaSoft
		...
		return Theme{
			...
			SelectionBg: pickColor(mode, "#D8E7FF", "#3A547A"),
